...
"------------------------------------
"let g:dbext_default_profile_postgres = 'type=PGSQL:host=localhost:user=example-org:dbname=dom_tour:passwd=example-org:port=9999'
"let g:dbext_default_profile_psql = 'type=PGSQL:host=localhost:port=9990:dbname=dom_tour:user=example-org:passwd=example-org'
