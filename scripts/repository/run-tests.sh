...
#
#   bash scripts/repository/run-tests.sh                        # 全部
#   bash scripts/repository/run-tests.sh --ci                   # `# ci-skip:` を飛ばす（CIから）
#   env TEST_DIR=tests/linear bash scripts/repository/run-tests.sh   # ドメインだけ
#
# 環境変数:
