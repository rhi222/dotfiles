...
#
#   bash scripts/settings/private-bundle.sh adopt [--execute]   # 散らばった実体を集約先へ（旧環境で1回）
#   bash scripts/settings/private-bundle.sh export [--out PATH] # パスワード付き zip に固める
#   bash scripts/settings/private-bundle.sh import <zip> [--force]
#   bash scripts/settings/private-bundle.sh status
#
